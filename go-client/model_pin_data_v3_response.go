...
// checks if the PinDataV3Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PinDataV3Response{}

// PinDataV3Response struct for PinDataV3Response
type PinDataV3Response struct {
	// Status
	...
	Data []ComponentDataV3ResponseDTO `json:"data,omitempty"`
}
...
func (o *PinDataV3Response) GetData() []ComponentDataV3ResponseDTO {
	if o == nil || IsNil(o.Data) {
		var ret []ComponentDataV3ResponseDTO
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ComponentDataV3ResponseDTO and assigns it to the Data field.
func (o *PinDataV3Response) SetData(v []ComponentDataV3ResponseDTO) {
	o.Data = v
}

func (o PinDataV3Response) MarshalJSON() ([]byte, error) {
...
func (o PinDataV3Response) ToMap() (map[string]interface{}, error) {
...
type NullablePinDataV3Response struct {
	value *PinDataV3Response
	isSet bool
}

func (v NullablePinDataV3Response) Get() *PinDataV3Response {
	return v.value
}

func (v *NullablePinDataV3Response) Set(val *PinDataV3Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePinDataV3Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePinDataV3Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePinDataV3Response(val *PinDataV3Response) *NullablePinDataV3Response {
	return &NullablePinDataV3Response{value: val, isSet: true}
}

func (v NullablePinDataV3Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePinDataV3Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
