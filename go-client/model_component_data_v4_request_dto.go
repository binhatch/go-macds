...
// checks if the ComponentDataV4RequestDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComponentDataV4RequestDTO{}

// ComponentDataV4RequestDTO struct for ComponentDataV4RequestDTO
type ComponentDataV4RequestDTO struct {
	// KType
...
type _ComponentDataV4RequestDTO ComponentDataV4RequestDTO
...
func NewComponentDataV4RequestDTO(ktype int32, language string, systemIdent string, componentId int32) *ComponentDataV4RequestDTO {
	this := ComponentDataV4RequestDTO{}
	this.Ktype = ktype
...
func (o ComponentDataV4RequestDTO) MarshalJSON() ([]byte, error) {
...
func (o ComponentDataV4RequestDTO) ToMap() (map[string]interface{}, error) {
...
func (o *ComponentDataV4RequestDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varComponentDataV4RequestDTO := _ComponentDataV4RequestDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varComponentDataV4RequestDTO)

	if err != nil {
		return err
	}

	*o = ComponentDataV4RequestDTO(varComponentDataV4RequestDTO)

	return err
}

type NullableComponentDataV4RequestDTO struct {
	value *ComponentDataV4RequestDTO
	isSet bool
}

func (v NullableComponentDataV4RequestDTO) Get() *ComponentDataV4RequestDTO {
	return v.value
}

func (v *NullableComponentDataV4RequestDTO) Set(val *ComponentDataV4RequestDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableComponentDataV4RequestDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableComponentDataV4RequestDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComponentDataV4RequestDTO(val *ComponentDataV4RequestDTO) *NullableComponentDataV4RequestDTO {
	return &NullableComponentDataV4RequestDTO{value: val, isSet: true}
}

func (v NullableComponentDataV4RequestDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComponentDataV4RequestDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
