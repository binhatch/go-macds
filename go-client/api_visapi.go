...
func (a *VISAPIAPIService) IdentExecute(r ApiIdentRequest) (*IdentResponse, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *IdentResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VISAPIAPIService.Ident")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ident"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.identRequestDTO == nil {
		return localVarReturnValue, nil, reportError("identRequestDTO is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.identRequestDTO
