...
// checks if the LocationsVehicleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocationsVehicleResponse{}

// LocationsVehicleResponse struct for LocationsVehicleResponse
type LocationsVehicleResponse struct {
	// Status
	...
	Data []LocationsVehicleDTO `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []LocationsVehicleDTO and assigns it to the Data field.
func (o *LocationsVehicleResponse) SetData(v []LocationsVehicleDTO) {
	o.Data = v
}

func (o LocationsVehicleResponse) MarshalJSON() ([]byte, error) {
...
func (o LocationsVehicleResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLocationsVehicleResponse struct {
	value *LocationsVehicleResponse
	isSet bool
}

func (v NullableLocationsVehicleResponse) Get() *LocationsVehicleResponse {
	return v.value
}

func (v *NullableLocationsVehicleResponse) Set(val *LocationsVehicleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLocationsVehicleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLocationsVehicleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocationsVehicleResponse(val *LocationsVehicleResponse) *NullableLocationsVehicleResponse {
	return &NullableLocationsVehicleResponse{value: val, isSet: true}
}

func (v NullableLocationsVehicleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocationsVehicleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
